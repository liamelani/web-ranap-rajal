            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image"
                        style="background-image: url('{{ asset('images/gb.jpg') }}');"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="{{ route('register.simpan') }}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input name="nama" type="text"
                                        ...
                                        id="exampleInputName" placeholder="Name" value="{{ old('nama') }}">
                                    @error('nama')
                                ...
                                <div class="form-group">
                                    <select name="level" class="form-control @error('level') is-invalid @enderror">
                                        ...
                                        <option value="dokter">Dokter</option> <!-- Tambahkan opsi dokter -->
