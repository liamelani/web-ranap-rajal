...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Data Laporan Rawat Inap</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('laporan_rawat_inap.update', $laporanRawatInap->id) }}">
                        @csrf
                        @method('PUT')

                        <div class="form-group">
                            <label for="No_Rawat">No. Rawat</label>
                            <input id="No_Rawat" type="text" class="form-control" name="No_Rawat" value="{{ $laporanRawatInap->No_Rawat }}" required autofocus>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="Biaya_Dokter" type="text" class="form-control" name="Biaya_Dokter" value="{{ $laporanRawatInap->Biaya_Dokter }}" required>
                        </div>

                        <!-- Script untuk mengambil detail pasien saat memilih No. RM Inap -->
                        <script>
                            ...
                            document.getElementById('no_tempat_tidur').addEventListener('change', function() {
                                var no_tempat_tidur = this.value;
