...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Tambah Data Pasien Rawat Jalan</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('pasien_rawat_jalan.store') }}">
                        @csrf

                        <div class="form-group">
                            <label for="No_RM_Jalan">No. RM Jalan</label>
                            <input id="No_RM_Jalan" type="text" class="form-control" name="No_RM_Jalan" value="{{ old('No_RM_Jalan') }}" required autofocus>
                        </div>
